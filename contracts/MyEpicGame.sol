...
// Our contract inheritst from ERC721, which is the standard NFT contract!
contract MyEpicGame is ERC721 {
    ...
    constructor(
     ...
     {
        // Initializing the boss. Save it to our global "bigBoss" state variable.
        bigBoss = BigBoss({
            name: bossName,
    ...
    // Users would be able to hit this function and get their NFT based on the charactedId they send in!
